"""
Django settings for zedi project.
...
SECRET_KEY = 's8xfn!)^v6wkb^ct+vymm*m4%#$^94m0m(6zp%zi07$l_5ah%('
...
WSGI_APPLICATION = 'zedi.wsgi.application'
...
ALGORITHM_RUN_MODE = AlgorithmRunMode.HISTORICAL
